...
void main()
{
    ...
    gl_Position = projection * vec4(aPosition, 0.0, 1.0);
        ...
        private int _brushHasTextureLocation;
        ...
        private void CacheUniformLocations()
        {
            ...
            _brushHasTextureLocation = _gl.GetUniformLocation(_program, "brushHasTexture");
        }
        ...
        private void SetBrushUniforms(Brush brush)
        {
            ...
            _gl.Uniform1(_brushHasTextureLocation, brush.UseTexture ? 1 : 0);
        }
